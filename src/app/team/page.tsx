...
const team = [
  { name: "Mojolaoluwa Ayeni", role: "Lead", focus: "Transaction Advisory", tone: "photo-duotone-gold", bio: "Mojolaoluwa Ayeni leads transaction advisory for IQ Syndicate. He is an advisory professional with experience supporting the development, assessment and structuring of investment opportunities across energy, infrastructure and other strategic sectors. Before IQ Syndicate, he supported a range of private and public-sector engagements at Fritova, including renewable energy and infrastructure projects, investment assessments, capital-raising initiatives and corporate transactions. His experience includes developing financial and economic models, assessing project viability and bankability, and supporting clients in evaluating and structuring investment opportunities. He is particularly interested in the role of capital in enabling infrastructure development and sustainable economic growth across Africa. Mojolaoluwa holds an MBA from Quantic School of Business and Technology and a B.Sc. in Economics from the University of Ibadan. He is also an Associate Chartered Accountant (ACA) and an Advanced Financial Modeler (AFM)." },
  { name: "Gift Adaugo", role: "Partner", focus: "Development Impact", tone: "photo-duotone-forest", bio: "Gift Nwamadu is a public policy researcher and climate finance advocate focused on gender-responsive climate policy in sub-Saharan Africa. She holds an MPhil in Public Policy at the University of Cambridge. Before joining IQ Syndicate, she served as a Climate Finance Analyst with the Climate Policy Initiative, tracking climate finance flows for its Africa Landscape of Climate Finance report. Over four years, she has combined executive-level operational leadership. She has helped organizations secure more than $1 million in grant funding for research on climate finance, gender equity, and institutional design. She is the founder of Policies Vault, an independent think tank, and writes widely on climate finance and women's economic participation." },
  { name: "Ghenzini Arigor", role: "Partner", focus: "Capital Mobilization", tone: "photo-duotone-forest", bio: "Ghenzini is an economist and partner at IQ Syndicate. He has deep expertise in climate finance, investment structuring, and clean energy infrastructure development in Africa. He has co-led the structuring of green bond instruments aligned with the ICMA Green Bond Principles and has supported transaction advisory, due diligence, and the review of climate finance instruments valued at over US$275 million. He has provided investment, commercialisation, and technical advisory support to climate ventures under donor-funded programmes, contributing to the development and scaling of early-stage clean energy businesses. He has also supported national carbon market initiatives, including engagement with the European Commission on the implementation of Article 6 frameworks in Nigeria. His expertise spans the full investment value chain, including research, project origination, transaction advisory, capital mobilisation, and climate policy. He holds professional certifications in Climate Finance, Project Finance, Financial Modelling, and Private Equity from internationally recognised institutions, including the Corporate Finance Institute (CFI), Bocconi University, and the University of Pennsylvania." },
  { name: "Anietie Udoaka", role: "Head", focus: "Platform & Product Development", tone: "photo-duotone-gold", bio: "Anietie Udoaka is a mobile platform engineer with seven years of experience in production software, five of them leading Android and Flutter development for regulated financial services in Nigeria. Before joining IQ Syndicate, he served as Team Lead for Mobile Development at Mintyn Online Bank, a licensed digital bank, where he owned the core mobile architecture and the engineering standards, multi-module design, automated testing, CI/CD, and release governance that the wider team builds against. His work has standardised development across the mobile team. He has shipped core banking products to a customer base in the tens of thousands and contributes to native Android and Flutter applications for Gopaddi Technologies. He holds a B.Sc. in Genetics and Biotechnology from the University of Calabar and is now focused on leading the technical functions at IQ Syndicate from first commit through platform maturity." },
  { name: "Francis Nwalibe", role: "Head", focus: "Risk & Private Credit", tone: "photo-duotone-burgundy", bio: "Francis is a dynamic investment professional with extensive experience spanning Corporate Finance, Venture Capital, Project Finance, Investment Management, and Capital Markets. He has executed private debt and equity raises with combined value exceeding $25M in the Financial Services, Agriculture, Renewable Energy, Technology, Infrastructure, and Power sectors. Before IQ Syndicate, he served as Head of Capital Markets at BAS Capital Limited, where he provided coverage for growth- and scale-stage MSMEs in business advisory, mergers and acquisitions, project finance, and debt and equity capital markets. In addition, he is a Venture Fellow with Dream VC, where he conducts market sizing, preliminary screening and due diligence, memo building, and valuation for Agtech, Climate Tech, Fintech, and Food Tech startups. Previously, he was Team Lead, Investments and Trade at Welcome2Africa, where he spearheaded deal sourcing, LP relations, and fundraising for the $100M Sustainable Agriculture Fund, focused on building the climate resilience of smallholders. In addition to leading origination, structuring, and execution of private debt and equity deals, he led consultancy engagements with USAID, UNDP, 2SCALE, IFDC, GIZ, and others." },
  { name: "Shamim Ibrahim", role: "Head", focus: "Equity Valuations", tone: "photo-duotone-burgundy", bio: "Shamim Ibrahim is Head of Equity Valuations at IQ Syndicate, where she leads the firm's approach to valuing early-stage climate ventures and assessing equity investment opportunities across its pipeline. Prior to joining IQ Syndicate, Shamim spent over four years at BlackRock, working across investment product strategy and development and supporting the launch of investment products across multiple asset classes and markets. She subsequently completed an MPhil in Public Policy at the University of Cambridge, where her work focused on climate finance, economic development, and the role of private capital in addressing development challenges. She also worked with the Environmental Defense Fund on green transition policies in the Global South. Shamim also holds a BA in Economics, Arabic, and Global Studies from the University of Richmond." },
  { name: "Regina Godwin", role: "Lead", focus: "Insights, Market Research & AI Intelligence", tone: "photo-duotone-forest", bio: "Regina is an AI Engineer and Data Scientist who designs and deploys enterprise-scale artificial intelligence, machine learning, and analytics solutions across cybersecurity, customer analytics, and cloud platforms. She specializes in building production-ready AI applications using Azure OpenAI, FastAPI, Oracle technologies, and Azure data services to solve complex business challenges. Before IQ Syndicate, she worked as a Data Scientist and AI Engineer at Access Bank PLC. Regina has delivered AI-powered automation that has compressed operational processes from weeks to minutes, accelerated enterprise decision-making, and enabled data-driven business and security operations. Among her signature achievements, she architected a production-grade AI Vulnerability Management Agent, built on Azure OpenAI GPT-4o, FastAPI, and React, that reduced vulnerability ownership identification across roughly 6,500 technology assets from as long as two weeks to under two minutes. At Access Bank Plc, she also developed an XGBoost customer churn model leveraging approximately 43 million records with over 90% precision, recall, and accuracy, and a Commercial Banking Pareto prediction framework that achieved around 97% accuracy in identifying the bank's highest-value customers. She holds a BSc in Economics and an extensive portfolio of professional certifications, including Microsoft Certified: Fabric Data Engineer Associate, Azure Data Scientist Associate, and multiple Azure and AWS AI credentials." },
  { name: "James Nwefuru", role: "Lead", focus: "Renewable Energy Business Development", tone: "photo-duotone-gold", bio: "James heads the business development unit at IQ Syndicate. He is an infrastructure finance and sustainable development professional whose career bridges technical engineering with transaction advisory, connecting infrastructure design to financial structuring and project delivery. He supported a $300 million pipeline of infrastructure development and financing initiatives across Nigeria and Africa, working across government, development finance institutions, private investors, and technical partners on feasibility studies, financial models, transaction documentation, and implementation strategy for complex infrastructure programmes. His portfolio spans flagship national and continental programmes, including Nigeria's Special Agro-Industrial Processing Zones initiative, renewable energy and rural electrification under the UK PACT Run-of-River Small Hydropower Programme, and climate-focused urban development delivered in collaboration with C40 Cities across selected African countries. Before transitioning into infrastructure advisory, he built over four years of experience as a Green Structural Engineer, contributing to the design and delivery of more than twenty sustainable buildings, transport, and public-sector projects grounded in resource-efficient engineering and low-carbon construction." },
];
...
const advisoryBoard = [
  ...
  },
  {
    ...
    image: "/images/advisory/Zainab Aliyu.png",
        ...
        <Container>
          ...
          <div className="grid grid-cols-2 gap-x-8 gap-y-14 sm:grid-cols-3 md:gap-x-12 md:gap-y-16">
            {team.map((member, i) => {
              ...
              const dirs = ["left","up","right","left","up","right","left","up"] as const;
              return (
