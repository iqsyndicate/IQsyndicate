...
const team = [
  ...
  { name: "Ghenzini Edet", role: "Partner", focus: "Capital Mobilization", tone: "photo-duotone-forest", bio: "Ghenzini is an economist and partner at IQ Syndicate. He has deep expertise in climate finance, investment structuring, and clean energy infrastructure development in Africa. He has co-led the structuring of green bond instruments aligned with the ICMA Green Bond Principles and has supported transaction advisory, due diligence, and the review of climate finance instruments valued at over US$275 million. He has provided investment, commercialisation, and technical advisory support to climate ventures under donor-funded programmes, contributing to the development and scaling of early-stage clean energy businesses. He has also supported national carbon market initiatives, including engagement with the European Commission on the implementation of Article 6 frameworks in Nigeria. His expertise spans the full investment value chain, including research, project origination, transaction advisory, capital mobilisation, and climate policy. He holds professional certifications in Climate Finance, Project Finance, Financial Modelling, and Private Equity from internationally recognised institutions, including the Corporate Finance Institute (CFI), Bocconi University, and the University of Pennsylvania." },
